...
public class QMember extends EntityPathBase<Member> {
    ...
    public final StringPath expertiseField = createString("expertiseField");
    ...
    public final NumberPath<java.math.BigDecimal> starAverage = createNumber("starAverage", java.math.BigDecimal.class);
