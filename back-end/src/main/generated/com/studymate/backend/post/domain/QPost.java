...
public class QPost extends EntityPathBase<Post> {
    ...
    public final ListPath<com.studymate.backend.heart.domain.Heart, com.studymate.backend.heart.domain.QHeart> heart = this.<com.studymate.backend.heart.domain.Heart, com.studymate.backend.heart.domain.QHeart>createList("heart", com.studymate.backend.heart.domain.Heart.class, com.studymate.backend.heart.domain.QHeart.class, PathInits.DIRECT2);
